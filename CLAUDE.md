...
- Validate any user-supplied value before using it as a storage key/path segment/identifier — reject path separators and other structural characters via an explicit allow-list pattern.
